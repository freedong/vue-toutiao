<template lang="html">
  <div id="selfpage">
    ...
    <header-bar>
      <div slot="selfpage">
        <Icon type="ios-arrow-back" size="28" color="#fff" class="fl back" @click.native="goBack"></Icon>
        <span class="my-selfpage">我的主页</span>
        <Icon type="md-share-alt" size="28" color="#fff" class="fr share" @click.native="showSharebox"></Icon>
      </div>
    </header-bar>
    ...
    <router-link to="/editprofile" v-if="!hasIntroduce" class="editIntroduce">
      <Icon type="ios-edit" size="16" color="blue"></Icon>
      添加个人简介...
    </router-link>
          ...
          <div class="rightInfo">
            ...
            <div class="self_todo clearfix">
              <span @click="showSharebox">
                <Icon type="md-share-alt" size="20"></Icon>
                分享
              </span>
...
export default {
  ...
  watch:{
    '$route':function(){
      ...
      console.log('$route'+this.Sharebox)
    }
  },
  created(){
    this.getSelfComment();
  ...
  methods:{
    ...
    getSelfComment(){
      axios.get('/src/static/self_comment.json').then(res=>{
        const Data = res.data;
